...
<li><a href="PatientRegs.php"> Patient </a></li>
<li><a href="#"Home</a></li>
<li><a href="#"Home</a></li>
<li><a href="#"Home</a></li>
<li><a href="#"Home</a></li>
...
<form id ="frm" style= "color:DodgerBlue"   action="DonorRegscon.php" method="post" name="frm" >
...
Last Blood Donation Date : <input onkeyup="lbdd()" type="date" name="lbday" id="txt"><span id="msg"></span> <br><br>
Phone No:
