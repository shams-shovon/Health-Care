...
<form id ="frm" style= "color:black"   action="RegistrationDoctorcon.php" method="post" name="frm" >
...
<input type="radio" name="gender" value="other" > Other<br><br>
 Catagory:
  ...
  <br><br>
  Experience: (in yrs)
<input onkeyup="exp()" type="text" placeholder=" type your experience" name="experience" id="txt"><span id="msg"></span> 
  <br><br>
   Location:

<input onkeyup="lct()" type="text" placeholder=" Type your Location" name="location" id="txt"><span id="msg"></span> 
  <br><br>
 Timings:
<input onkeyup="tm()" type="text" placeholder="...-..." name="timing" id="txt"><span id="msg"></span> 
  <br><br>
Phone No:
...
<input onkeyup="confpass1()" type="password" placeholder="confirm your password" name="confpass" id="txt"><span id="msg"></span>
  <br><br>
  <input type="submit" onclick="return validate()" name="sbt" value="submit" /><h1 style= "color:DodgerBlue "font-size:40px;" align="center" > Welcome !!</h1>
