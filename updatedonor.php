...
<ul>
<li><a style="text-decoration: none" href="Donor_home_page.html"> <h3 style="color: DodgerBlue;">Home</h3> </a></li>
</ul>
</nav>
</body>
</html>
...
if ($confirm == 0)
{
	...
	$sql = "UPDATE `donor` SET `first_name`='".$_POST["firstname"]."',`last_name`='".$_POST["lastname"]."', `address`='".$_POST["address"]."', `dob`='".$_POST["bday"]."' ,`gender`='".$_POST ["gender"]."', `blood_group`='".$_POST ["bloodgroup"]."', `last_donate_date`='".$_POST ["lbday"]."', `phone`='".$_POST ["phn"]."', `email`='".$_POST ["email"]."' WHERE id = '".$_SESSION['uname']."'";
