...
if($confirm == 0){
	...
	$conn = mysqli_connect("localhost", "root", "","web_tech");
		...
		$sql = "UPDATE `patient` SET `first_name`='".$_POST["firstname"]."',`last_name`='".$_POST["lastname"]."', `address`='".$_POST["address"]."', `dob`='".$_POST["bday"]."' ,`gender`='".$_POST ["gender"]."', `problem`='".$_POST ["pblm"]."', `phone`='".$_POST ["phn"]."', `email`='".$_POST ["email"]."' WHERE id = '".$_SESSION['uname']."'";
